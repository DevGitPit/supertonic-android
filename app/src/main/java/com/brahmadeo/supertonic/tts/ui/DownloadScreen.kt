...
fun DownloadScreen(
    ...
    val message = when (version) {
        ...
        "v3" -> "Downloading Supertonic-3 Models (~385MB). This enables support for 31 languages with higher quality and expression tags. This specific download happens only once."
